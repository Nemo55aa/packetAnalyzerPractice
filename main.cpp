...
void initGTKfunctions(int &argc, char** &argv, myAppWidgets_t &wdg){
    ...
    gtk_list_box_insert(GTK_LIST_BOX(wdg.listbox), gtk_label_new("Windows"),  -1);
    gtk_list_box_insert(GTK_LIST_BOX(wdg.listbox), gtk_label_new("macOS"),    -1);
    gtk_list_box_insert(GTK_LIST_BOX(wdg.listbox), gtk_label_new("Ubuntu"),   -1);
    gtk_list_box_insert(GTK_LIST_BOX(wdg.listbox), gtk_label_new("Fedora"),   -1);
    
    wdg.label   = gtk_label_new(NULL);
    wdg.label1  = gtk_label_new(NULL);
    ...
    gtk_box_pack_end  (GTK_BOX(wdg.vbox), wdg.label1,   0, 0, 0);
